...
export default function Page() {
  const adminLink = process.env.NEXT_PUBLIC_STRAPI_COLLECTION_URL + "api::advertisement.advertisement"
  ...
  return (
    <div>
      <div className="flex justify-between mb-5 ml-5">
        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Advertisement</h2>
